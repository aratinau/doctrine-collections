...
class GenusFormType extends AbstractType
{
    ...
    /**
     * There is one small bug left with our validation!
     * And it's tricky! To see it: add 2 new scientists,
     * immediately remove the first, leave the yearsStudied field blank, and then submit.
     * We should see a validation error appearing below the yearsStudied field.
     * Instead, it appears no the top of the form!
     * This is actually caused by a bug in Symfony,
     * but we can fix it easily! The following code block shows the fix and has more details:
     *
